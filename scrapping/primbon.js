      ...
      await axios
        ...
        .then(({ data }) => {
          ...
          if (adaga) {
            ...
            resolve(
              `Tidak ditemukan tafsir mimpi ${mimpi}. Cari dengan kata kunci yang lain..`
            );
          }
        })
        .catch(reject);
      ...
      await axios
        ...
        .then(({ data }) => {
          ...
          const result = {
            ...
            thumbnail:
              "https://www.primbon.com/" + $("#body > img").attr("src"),
          };
          resolve(result);
        })
        .catch(reject);
      ...
      await axios(options)
        .then(({ data }) => {
          ...
          const res = $("#body")
            ...
            .replace(/< Hitung Kembali.*$/s, "");
          const stats =
            "https://www.primbon.com/" + $("#body > span > img").attr("src");
          const result = {
            penjelasan: res,
            statistik: stats,
          };
